...
export function previewPdf(doc: jsPDF, filename: string) {
  ...
  overlay.style.cssText =
    "position:fixed;inset:0;z-index:9999;background:rgba(20,10,30,.6);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:18px;";
  ...
  bar.innerHTML = `<span style="font-weight:600;font-size:14px;flex:1;">${filename}</span>`;
