...
const CHECKLIST_GERAL = [
  "Telhado — integridade das telhas e estrutura de cobertura",
  "Goteiras e infiltrações no telhado, forro e paredes",
  "Calhas, rufos e condutores — limpeza e escoamento",
  "Pintura da fachada",
  "Pintura das janelas e esquadrias",
  "Fachada, testeira e identidade visual do prédio",
  "Vidros, portas e portões de acesso",
  "Estrutura predial — paredes, vigas e pilares",
  "Piso das áreas comuns — integridade e nivelamento",
  "Escadas, rampas e corrimãos",
  "Reservatórios (caixas d'água) e rede hidráulica",
  "Rede de esgoto, ralos e drenagem",
  "Sanitários — louças, torneiras e conservação",
  ...
  "Prevenção e combate a incêndio — extintores, hidrantes e saídas de emergência",
  "Segurança patrimonial física/remota (art. 7º, §6º)",
  "Limpeza geral e coleta de lixo (art. 7º, §7º e §8º)",
